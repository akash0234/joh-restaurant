...
!(function (a) {
    ...
    function d() {
        w > 976 &&
            a(".blog-item").each(function () {
                var b = a(this).outerHeight();
                a(this).find(".blog-img").css("height", b);
            });
    }
    function e() {
        w >= 991 && a(".directionhover").length && a(".directionhover  a").hoverdir({ speed: 400, easing: "ease-in-out" });
    }
    function f() {
        var a = {
                zoom: 8,
    ...
    function l() {
        ...
        if (a("#cartItemsType2").length) {
            ...
            "" === b && (b = '<div class="clearfix"><div class="big-content"><div class="product-cart-wrap"><h5>Sorry, you do not have any product in cart.</h5></div></div></div>'), a("#cartItemsType2").html(b);
        }
    }
    function m(a, b, c, d, e, f) {
        for (var g = "", h = 1; 5 > h; h++) g += '<option value="' + h + '"' + (d === h ? "selected" : "") + ">" + h + " product</option>";
        return 1 === f
            ? '<div class="clearfix"><div class="big-content"><div class="product-cart-wrap"><figure><img src="' +
                  a +
                  '" alt="image"></figure>  <h5>' +
                  b +
                  '</h5></div></div><div class="big-content medium-content productQuantity"><select class="form-control" data-id="' +
                  e +
                  '">' +
                  g +
                  '</select></div><div class="big-content small-content"><h5>$ ' +
                  c +
                  "</h5></div></div>"
            : '<li class="clearfix"><div class="item-content"><div class="item-image"><img src="' +
                  ...
                  b +
                  '</h6><div class="productQuantity"><select class="form-control" data-id="' +
                  e +
                  '">' +
                  g +
                  '</select></div><div></div></div></div><div class="item-price"><span>$ ' +
                  c +
    ...
    function n() {
        991 >= w
            ? a(".toggle-dropdown").on("click", function (b) {
    ...
    function r() {
        if (a(window).width() > 750) {
            ...
            j.length &&
                j.waypoint(
                    function () {
                        j.find(".order-type-wrapper:nth-of-type(1)").addClass("animated fadeInLeft"),
                            setTimeout(function () {
            ...
            k.length &&
                k.waypoint(
                    function () {
                        k.find(".service-wrapper:nth-of-type(1)").addClass("animated bounceInUp"),
                            setTimeout(function () {
            ...
            l.length &&
                l.waypoint(
                    function () {
                        l.find(".cup").addClass("animated fadeInUp"),
                            setTimeout(function () {
            ...
            n.length &&
                n.waypoint(
                    function () {
                        n.find("li:nth-of-type(1)").addClass("animated bounceIn"),
                            setTimeout(function () {
    ...
    A.length && A.slimScroll({ height: "100%", color: "#dc8068", allowPageScroll: !0 }), 0 !== a("#map-canvas").length && google.maps.event.addDomListener(window, "load", f);
    var B = a("#masonry-layout");
    if (B.length) {
        var C = a(".grid-item"),
            D = { isAnimated: !0, isFitWidth: !0, gutter: ".gutter" };
        C.hide(),
    ...
    if (
        ...
        l(),
        k(),
        a(".addToCart").on("click", function (b) {
            b.preventDefault();
            var c = a(this),
                d = { id: c.data("productid"), name: c.data("productname"), price: c.data("productprice"), image: c.data("productimage"), quantity: 1 };
            i(d),
                c
                    .addClass("cart-added")
                    .delay(1e3)
        ...
        a(".buy-btn").on("click", function () {
            var b = a(this).prev(),
                c = { id: b.data("productid"), name: b.data("productname"), price: b.data("productprice"), image: b.data("productimage"), quantity: 1 };
        ...
        a(".submenu").prev().addClass("toggle-dropdown"),
        n(),
        a(".datetime").length && o(a(".datetime")),
        a("#reservation-form").on("submit", function (b) {
            if ((b.preventDefault(), a(this).parsley().isValid())) {
                var c = a(this).serializeArray();
                a(".ajaxmessage.for-reservation").removeClass("hidden").text("Sending.."),
                    a.ajax({ url: "php/reservation.php", type: "POST", async: !0, data: c }).done(function (b) {
        ...
        a("#contactform").on("submit", function (b) {
            if ((b.preventDefault(), a(this).parsley().isValid())) {
                var c = a(this).serializeArray();
                a(".ajaxmessage.for-contactform").removeClass("hidden").text("Sending.."),
                    a.ajax({ url: "php/contact.php", type: "POST", async: !0, data: c }).done(function (b) {
        ...
        a("#orderform").on("submit", function (b) {
            ...
            if ((a("#selectedProducts").val(d), a(this).parsley().isValid())) {
                ...
                a(".ajaxmessage.for-orderform").removeClass("hidden").text("Sending.."),
                    a.ajax({ url: "php/order.php", type: "POST", async: !0, data: e }).done(function (b) {
        ...
        H.each(function () {
            ...
            b.countdown(c, function (a) {
                b.html(
                    a.strftime(
                        '<div class="time-circle"><h3>%D</h3><h5>days</h5></div><div class="time-circle"><h3>%H</h3><h5>hours</h5></div><div class="time-circle"><h3>%M</h3><h5>minutes</h5></div><div class="time-circle"><h3>%S</h3><h5>seconds</h5></div>'
                    )
                );
            });
        });
    ...
    a("a.back-to-top").on("click", function (b) {
        a("html, body")
            .stop()
            .animate({ scrollTop: a("body").offset().top }, 1500),
            b.preventDefault();
    }),
        a(".selectbox_itemlist span").on("click", function () {
            var b, c, d;
            (b = a(this).text()),
                (c = a(this).attr("data-value")),
                (d = a(this).parent().parent()),
                d.find(".selectbox_toggle").text(b).append('<span class="selectbox__arrow"></span>').attr("data-value", c),
                d.find(".selectbox__input").val(c);
        }),
